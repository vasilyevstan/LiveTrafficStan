...
describe('PWA manifest and deployment headers', () => {
  ...
  it('revalidates mutable shell entry points and isolates immutable icons', async () => {
    ...
    expect(headers).toContain(
      "connect-src 'self' https://tiles.openfreemap.org https://photon.komoot.io https://meri.digitraffic.fi wss://meri.digitraffic.fi https://api.adsb.lol https://api.planespotters.net",
    )
    expect(headers).toContain(
